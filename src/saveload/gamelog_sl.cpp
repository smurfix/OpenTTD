...
static const SaveLoad _gamelog_desc[] = {
	...
	SLE_CONDVAR(LoggedAction, tick,              SLE_FILE_U16 | SLE_VAR_U32, SL_MIN_VERSION, SLV_SLOWPACE),
	SLE_CONDVAR(LoggedAction, tick,              SLE_UINT32, SLV_SLOWPACE, SL_MAX_VERSION),
