...
class Main:
    ...
    async def handle_result2(self, msg):
        ...
        """
        data = openttd.internal.CommandData(msg.cmd,msg.tile,msg.p1,msg.p2,msg.p3)
        for k,evt in self._replies.items():
            if k.data == data and k.company == msg.company:
                break
        else:
    ...
    def send_cmd(self, data:CommandData, company=None) -> Awaitable[CommandResult]:
        """
        ...
        self.send(openttd.internal.msg.CmdRelay(data, company))
